...
class ClockRenderer {
    ...
    func draw(in rect: NSRect, timeState: TimeState, isPreview: Bool) {
        ...
        if cachedStaticContent == nil || cachedSize != rect.size || cachedIsPreview != isPreview {
            cachedStaticContent = renderStaticContent(rect: rect, center: center, radius: radius, faceRadius: faceRadius, isPreview: isPreview)
    ...
    private func renderStaticContent(rect: NSRect, center: CGPoint, radius: CGFloat, faceRadius: CGFloat, isPreview: Bool) -> CGImage? {
